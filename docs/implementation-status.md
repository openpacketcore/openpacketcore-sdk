...
| GAP-PROTO-003 | 005 | NGAP codec (ASN.1 APER) | partial — [`ADR 0013`](adr/0013-ngap-asn1-strategy.md) | `opc-proto-ngap` | Root container construction and canonical encoding match independent Release 18 evidence for 15 outcomes. Bounded fragmentation avoids generated framing defects; raw preservation and existing decode policies remain available. Typed N3IWF fields and Initial UE/Downlink NAS/Uplink NAS required-field admission have independent evidence. Remaining: applicable optional fields outside this subset, nested resource transfers, other mandatory/conditional presence rules, further N3IWF procedures, and live interoperability evidence (#787). |

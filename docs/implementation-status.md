...
| GAP-PROTO-003 | 005 | NGAP codec (ASN.1 APER) | partial — [`ADR 0013`](adr/0013-ngap-asn1-strategy.md) | `opc-proto-ngap` | Root container construction and canonical encoding match independent Release 18 evidence for 15 outcomes. Bounded fragmentation avoids generated framing defects; raw preservation and existing decode policies remain available. Typed N3IWF fields, Initial UE/Downlink NAS/Uplink NAS, UE Release Command/Complete, and all three NG Setup outcomes have independent required-field evidence. Setup covers bounded root PLMN/slice/GUAMI lists and preserves receiver-ignore DRX/IAB behavior. Remaining: applicable optional fields outside this subset, nested resource transfers, other mandatory/conditional presence rules, further N3IWF procedures, and live interoperability evidence (#787). |

...
| GAP-PROTO-003 | 005 | NGAP codec (ASN.1 APER) | partial — [`ADR 0013`](adr/0013-ngap-asn1-strategy.md) | `opc-proto-ngap` | Root container construction and canonical encoding now match independent Release 18 evidence for 15 outcomes. Bounded open-type fragmentation avoids the generated runtime framing defects; raw preservation and existing decode policies remain available. Remaining: typed semantic IE construction/validation, mandatory and conditional presence, further N3IWF-applicable procedures, and live interoperability evidence (#787). |

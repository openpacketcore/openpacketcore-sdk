...
- **Rust crates** for protocol codecs (GTP-U, PFCP, NAS-5GS, NGAP v0, the
  experimental `opc-proto-gtpv2c` S2b subset, and the experimental
  `opc-proto-ikev2` header/payload-chain scaffold), session management,

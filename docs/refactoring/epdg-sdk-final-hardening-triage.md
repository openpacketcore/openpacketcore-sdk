...
| IKEv2 scaffold conformance defaults and fuzz workflow coverage | `T-3fc6bb76`; `.github/workflows/fuzz.yml` includes `opc-proto-ikev2` and `opc-proto-gtpv2c` | Converted and closed. Remaining broader typed-payload, SKF decrypt/queue integration, and fixture-provenance work is documented as experimental future scope. |

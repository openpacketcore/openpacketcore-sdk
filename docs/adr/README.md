...
| [0021](0021-sequential-session-raft-wal.md) | A private sequential, segmented session Raft WAL with bounded group commit retains SQLite application and the consumer contract; recovery, migration and performance qualification remain required. |

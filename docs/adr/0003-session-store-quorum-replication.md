...
The exact consensus profile is transport/wire-schema revision 5 and error-set
...
semantic boundary into the exact profile. Older profiles fail before engine

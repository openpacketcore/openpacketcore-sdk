...
impl EcdhKeyExchange {
    ...
    fn algorithm(&self) -> Result<&'static aws_lc_rs::agreement::Algorithm, CryptoError> {
        match self.group {
            NamedGroup::X25519 => Ok(&X25519),
            NamedGroup::Secp256r1 => Ok(&ECDH_P256),
            NamedGroup::Secp384r1 => Ok(&ECDH_P384),
            _ => Err(CryptoError::UnsupportedKeyExchangeGroup(self.group)),
        }
    }
}

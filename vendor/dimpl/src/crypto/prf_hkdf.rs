...
pub fn prf_tls12(
    ...
    let mut hmac_a = Zeroizing::new([0u8; MAX_HASH_LEN]);
    ...
    let result = (|| {
        ...
        let hash_len = hmac.hmac(hash, secret, label_seed, hmac_a.as_mut())?;
        ...
        while out.len() < output_len {
            ...
            let mut hmac_block = Zeroizing::new([0u8; MAX_HASH_LEN]);
            let block_len = hmac.hmac(hash, secret, payload, hmac_block.as_mut())?;
            ...
            if out.len() < output_len {
                ...
                hmac.hmac(hash, secret, &payload[..hash_len], hmac_a.as_mut())?;

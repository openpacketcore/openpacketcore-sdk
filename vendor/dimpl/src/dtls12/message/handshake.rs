...
impl Handshake {
    ...
    pub fn parse(
        ...
        if header.msg_type == MessageType::Certificate
            && header.length as usize
                > super::certificate::MAX_CERTIFICATE_LIST_BYTES.saturating_add(3)
        {
    ...
    pub fn defragment<'b>(
        ...
        let Some((first_handshake, first_buffer)) = iter.next() else {

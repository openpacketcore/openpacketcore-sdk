...
pub use consumer::{
    ...
    SessionConsumerRosterCommitment, SessionConsumerRosterError, SessionConsumerRosterMember,
    SessionConsumerRosterRejection, SessionConsumerRosterTerminalCapsule,
    ...
    SessionQuorumRosterIngress, StatelessSessionConsumer,

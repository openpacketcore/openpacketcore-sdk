...
pub use backend::{
    ...
    ProtectedSelectorLedgerBase, ProtectedSessionBackend, REPLICATION_TX_ID_CANONICAL_BYTES,
    REPLICATION_TX_ID_MAX_BYTES, REPLICATION_TX_ID_MIN_BYTES, RecordExpiryPreflight,
    ...
    SessionBackend, SessionOp, SessionOpResult, next_replication_sequence,

...
pub use typed::{
    ...
    Indication, PdnAddressAllocation, PdnAddressAllocationError, PdnType, PdnTypeValue, PlmnId,
    ProtocolConfigurationOptions, RatType, RatTypeValue, Recovery, SelectionMode,
    ...
    MAX_DUPLICATE_IE_EVIDENCE, PAA_ASSIGNED_IPV6_PREFIX_LENGTH,
};

...
| [`opc-proto-ngap`](crates/opc-proto-ngap/) | Experimental NGAP APER: outcome-aware framing, canonical container construction from opaque IE values, 15-outcome Release 18 evidence, and raw-preserving re-encode. | [RFC 005](docs/rfc/005-protocol-framework.md), [ADR 0013](docs/adr/0013-ngap-asn1-strategy.md) |

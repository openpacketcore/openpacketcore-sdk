...
The GTP-U user-plane codec is also applicable to LTE/EPC user plane. GTPv2-C support, where present, is limited to an experimental S2b scaffold; no Diameter or S1AP protocols are provided.
...
| [`opc-proto-gtpv2c`](crates/opc-proto-gtpv2c/) | GTPv2-C (TS 29.274) S2b scaffold: raw-preserving header/IE shell for future typed procedure work *(experimental scaffold)*. | — |

...
| [`opc-proto-ngap`](crates/opc-proto-ngap/) | Experimental NGAP APER: canonical containers, bounded N3IWF fields, three NAS, two UE release and three NG Setup outcomes, 15-outcome framing evidence, and raw-preserving re-encode. | [RFC 005](docs/rfc/005-protocol-framework.md), [ADR 0013](docs/adr/0013-ngap-asn1-strategy.md) |

...
| [`opc-ipsec-xfrm`](crates/opc-ipsec-xfrm/) | Safe Linux XFRM IPsec backend model, mock backend, and redaction-safe errors. | [ADR 0017](docs/adr/0017-sctp-transport-ffi-boundary.md) |
